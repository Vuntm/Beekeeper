...
<body class="bg-gray-200">
    <div class="flex justify-between items-center">
        <div class="filter-section mb-3">
            <label for="CuaHang">Chọn chi nhánh:</label>
            <select name="CuaHang" id="CuaHang" class="form-control" style="width: 300px; display: inline-block;" onchange="filterByBranch()">
                <option value="0">Tất cả chi nhánh</option>
                <?php foreach ($ch as $cuaHangItem): ?>
                    <option value="<?php echo $cuaHangItem['ID_CuaHang']; ?>">
                        <?php echo $cuaHangItem['TenCuaHang']; ?>
                    </option>
                <?php endforeach; ?>
            </select>
        </div>
                ...
                <div class="modal-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="chiNhanh" id="chiNhanh" class="form-control" required>
                                <?php foreach ($ch as $cuaHangItem): ?>
                                    <option value="<?php echo $cuaHangItem['ID_CuaHang']; ?>">
                                        <?php echo $cuaHangItem['TenCuaHang']; ?>
                                    </option>
    ...
    <script>
        ...
        function editEmployee(button) {
            ...
            // Thiết lập giá trị cho dropdown chi nhánh
            var chiNhanhDropdown = document.getElementById("chiNhanh");
            var chiNhanh = row.cells[7].innerText.trim();
            for (var i = 0; i < chiNhanhDropdown.options.length; i++) {
                if (chiNhanhDropdown.options[i].text.trim() === chiNhanh) {
                    chiNhanhDropdown.selectedIndex = i;
                    break;
                }
            }
